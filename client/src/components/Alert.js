 ...
 * Dismissible inline alert for success / error / warning / info messages.
 *
 * Usage:
 *   <Alert type="error" message="Something went wrong." onClose={() => setMsg(null)} />
 */
...
const Alert = ({ type = "info", message, onClose }) => {
  ...
  return (
    <div
      role="alert"
      className={`flex items-start gap-3 rounded-lg border px-4 py-3 text-sm ${wrapper}`}
    >
